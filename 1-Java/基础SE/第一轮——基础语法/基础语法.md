...
![image-20220510231447239](img/image-20220510231447239.png)
...
![image-20220510231456645](img/image-20220510231456645.png)
...
https://blog.csdn.net/yongbutingxide/article/details/89501998
...
```Java
int i= 1; //int类型变量
System.out.println(getType(i)); //打印变量类型为Integer
```
...
//1、printf
System.out.printf(“x=%d,y=%f”,2,12.1);
System.out.println();
//2、println
System.out.println(“x=”+2+",y="+12.1);
//3、format
System.out.format(“x=%d,y=%f”,2,12.1);
System.out.println();
//4、Formatter
Formatter formatter = new Formatter(System.out);
formatter.format(“x=%d,y=%f”,2,12.1);
System.out.println();
formatter.close();
...
+ 获取Class类     Class<?> c = 
+ 获取类构造方法（分公共和全部，单个和数组）  Constructor<?>
+ 创建对象   con.newInstance();
...
https://blog.csdn.net/weixin_44572229/article/details/122961676

枚举（enum）类型是Java 5新增的特性，它是一种新的类型，允许用常量来表示特定的数据片断，而且全部都以类型安全的形式来表示。

所有的枚举都继承自java.lang.Enum类。由于Java 不支持多继承，所以枚举对象不能再继承其他类（可以实现接口）。 

![img](img/9aba2c6f00ef4d22b46a982101fc2f17.png)

## 自定义枚举类

![img](img/459819c32db54054a6f8ad610b927e6b.png)
...
![img](img/8f438e83b5964bc6b56bd640eaf38084.png)
...
enum Season2{
    //1.提供枚举对象，默认public static final Season2
    //多个对象之间用 , 隔开，末尾 ; 结束
    SPRING("春天"),
    SUMMER("夏天"),
    AUTUMN("秋天"),
...
![img](img/86d6423a584048e6b344c48001d41d8c.png)

...
![在这里插入图片描述](img/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2NkeTEyMjE=,size_16,color_FFFFFF,t_70.png)

解释：将源代码逐条转换成目标代码同时逐条运行的过程。

![在这里插入图片描述](img/20190709144005861.png)
...
![Java程序转变为机器代码的过程](img/java程序转变为机器代码的过程.png)
...
![编译型语言和解释型语言](img/编译型语言和解释型语言.png)
...
![types-of-exceptions-in-java.62f25be2](img/types-of-exceptions-in-java.62f25be2-16563981538825.png)
...
![img](img/unchecked-exception.png)
...
![img](img/a478c74d-2c48-40ae-9374-87aacf05188c.png)
...
![基本数据类型参数](img/java-value-passing-01.png)
...
![引用数据类型参数1](img/java-value-passing-02.png)
...
![引用数据类型参数2](img/java-value-passing-03.png)
...
![img](img/a478c74d-2c48-40ae-9374-87aacf05188c-165640231857423.png)
...
![TCP/IP 4层模型](img/6ecb84cd-4227-4c7b-a2e8-b77054604400-20200802201216504.png)
...
![img](img/8613ec4c-bde5-47bf-897e-99e0f90b9fa3.png)
...
![img](img/569e541a-22b2-4846-aa07-0ad479f07440.png)
...
![JDK1.7的ConcurrentHashMap](img/ConcurrentHashMap分段锁.jpg)

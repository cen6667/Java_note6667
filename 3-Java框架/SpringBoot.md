...
![image-20210131145025087](img/image-20210131145025087.png)
...
SpringBoot项目中spring-boot-maven-plugin报红解决办法
...
![image-20210131154347375](img/image-20210131154347375.png)
...
![image-20210203123205842](img/image-20210203123205842.png)
...
![image-20210203172830194](img/image-20210203172830194.png)
...
![image-20210205130208402](img/image-20210205130208402.png)
...
![image-20210204155358327](img/image-20210204155358327.png)
...
![image-20210207212036838](img/image-20210207212036838.png)
...
public String addEmp(Employee employee){
    ...
    //添加的操作
    employeeDao.save(employee); //调用底层业务的方法，保存员工的信息
...
直接在templates里面，新建一个error文件夹，然后新建404.html或者500.html 就可以了（不需要其他任何配置）
...
![image-20210210155341987](img/image-20210210155341987.png)
...
![图片](img/640-16548418013781.webp)

![图片](img/640-16548418013782.webp)
...
![image-20210213121643686](img/image-20210213121643686.png)
...
![image-20210213124606541](img/image-20210213124606541.png)
...
![image-20210213124929439](img/image-20210213124929439.png)
...
![image-20210213154023073](img/image-20210213154023073.png)
...
![image-20210213201432541](img/image-20210213201432541.png)
...
![image-20210213205817807](img/image-20210213205817807.png)
...
![image-20210214002526071](img/image-20210214002526071.png)



3、我们点击注销的时候，可以发现，spring security 帮我们自动删除了这个 cookie

![image-20210214002538990](img/image-20210214002538990.png)
...
![image-20210214124139597](img/image-20210214124139597.png)
...
![image-20210214124820923](img/image-20210214124820923.png)
...
![image-20210214175025512](img/image-20210214175025512.png)
...
![image-20210215171704288](img/image-20210215171704288.png)
...
![image-20210216005112825](img/image-20210216005112825.png)
...
![image-20210216010702645](img/image-20210216010702645.png)
...
![img](img/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3c4OTk4MDM2,size_16,color_FFFFFF,t_70.png)
...
![image-20210217214917336](img/image-20210217214917336.png)
...
![image-20210217220658006](img/image-20210217220658006.png)

![image-20210217220726799](img/image-20210217220726799.png)
...
![image-20210217222336980](img/image-20210217222336980.png)

测试，我们可以在/bin/下面，启动zkCli.cmd ，就可以启动测试了，要保证服务是开启的

![image-20210217222658978](img/image-20210217222658978.png)
...
![image-20210217224933176](img/image-20210217224933176.png)

4、执行 F:\Environment\dubbo-admin-master\dubbo-admin\target>java -jar dubbo-admin-0.0.1-SNAPSHOT.jar（新的在dubbo-admin-master\dubbo-admin-distribution\target）

![image-20210217225240888](img/image-20210217225240888.png)

注意，zookeeper的服务一定要启动着，不然dubbo-admin会启动失败的

执行完毕，我们去访问一下http://localhost:7001 (新版是8080)，使用root/root 就可以登录

登录成功后，查看界面

![image-20210217225530486](img/image-20210217225530486.png)
...
![image-20210217234038896](img/image-20210217234038896.png)
...
![image-20210218001655008](img/image-20210218001655008.png)
